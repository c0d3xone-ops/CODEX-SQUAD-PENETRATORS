...
if (isset($_GET['loader'])) {
    ...
    <body>
        <div class="fullscreen-banner-loader"><img src="https://i.ibb.co/DPY3vqFW/20260508-072604.jpg" alt="bg"></div>
...
if (!isset($_SESSION['kali_authenticated'])) {
    ...
    <body>
        <div class="fullscreen-banner"><img class="banner-img" src="https://i.ibb.co/DPY3vqFW/20260508-072604.jpg" alt="bg"></div>
